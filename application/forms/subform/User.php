...
class Application_Form_Subform_User extends Zend_Form_SubForm
{
   ...
   /*     $view=Zend_Layout::getMvcInstance()->getView(); */
        ...
        $this->username->getValidator('Db_NoRecordExists')->setMessage('Podany login jest już wykorzystany');
...
//////////////////////////////  KONTROLA E-MAIL
        ...
        Zend_Validate_NotEmpty::IS_EMPTY=>"Pole obowiązkowe"));
        $this->email->getValidator('Db_NoRecordExists')->setMessage('Podany e-mail jest już wykorzystany');
